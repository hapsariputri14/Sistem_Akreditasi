                ...
                @if ($isAdm || $isDos || $isAng)
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/publikasi') }}"
                            class="nav-link {{ request()->is('publikasi') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/penelitian') }}"
                            class="nav-link {{ request()->is('penelitian') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-laptop-code"></i>
                            <p>Penelitian</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/karya-buku') }}"
                            class="nav-link {{ request()->is('karya-buku') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/pengabdian-masyarakat') }}"
                            class="nav-link {{ request()->is('pengabdian-masyarakat') ? 'active' : '' }}">
